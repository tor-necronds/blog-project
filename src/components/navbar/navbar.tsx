...
export default function Navbar() {
  return (
    ...
    <div className="grid grid-cols-2  max-w-[1200px] bg-black w-full text-white">
    ...
    <Link href={`/blogs`} className='w-[100%] flex justify-center'>Home</Link>
    </div>
    ...
    <Link href={`/manage`} className='w-[100%] flex justify-center'>Manage</Link>
    </div>
    </div>
